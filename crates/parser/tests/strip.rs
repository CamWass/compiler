...
// use transform_testing::{test, test_exec, test_fixture, Tester};
use transform_testing::test;
// use swc_ecma_transforms_typescript::{strip, strip::strip_with_config, TsImportExportAssignConfig};

fn tr() -> impl for<'a> VisitMut<'a> {
...
test!(
    ::parser::Syntax::Typescript(Default::default()),
    |_| tr(),
    issue_392_2,
    "
