...
//                                         // id?: NodeId,                          // Unique id (used to look up NodeLinks)
...
// macro_rules! impl_has_node_data {
//     ($t:ty) => {
//         impl HasNodeData for $t {
//             fn node_data(&self) -> &NodeData {
//                 &self.node_data
//             }
//             // fn node_data_mut(&mut self) -> &mut NodeData {
...
// impl<T> HasTextRange for T
// where
//     T: HasNodeData,
// {
//     fn get_range_mut(&mut self) -> &mut TextRange {
//         self.node_data_mut().get_range_mut()
//     }
// }
...
//     pub transformFlags: TransformFlags, // Flags for transforms, possibly undefined
//     inner: Vec<T>,
// }
...
//             transformFlags: TransformFlags::empty(),
//             inner: Vec::new(),
//         }
//     }
// }
...
// impl_has_node_data!(Rc<Identifier>);

// impl PrimaryExpression for Rc<Identifier> {}
// impl Declaration for Rc<Identifier> {}
...
// impl HasNodeData for PropertyName {
//     fn node_data(&self) -> &NodeData {
//         todo!();
//     }
//     fn node_data_mut(&mut self) -> &mut NodeData {
...
// impl IsNode for PropertyName {
//     fn as_node(&self) -> Node {
//         todo!();
//     }
// }

// pub trait IsPropertyName {
//     fn isPropertyName(&self) -> bool {
//         self.asPropertyName().is_some()
//     }
//     fn asPropertyName(&self) -> Option<PropertyName>;
// }
...
// impl IsPropertyName for DeclarationName {
//     fn asPropertyName(&self) -> Option<PropertyName> {
//         match self {
//             DeclarationName::Identifier(n) => Some(PropertyName::Identifier(n.clone())),
//             // DeclarationName::PrivateIdentifier(n) => Some(PropertyName::PrivateIdentifier(n)),
//             // DeclarationName::StringLiteralLike(n) => Some(PropertyName::StringLiteral(n)),
//             // DeclarationName::NumericLiteral(n) => Some(PropertyName::NumericLiteral(n)),
//             // DeclarationName::ComputedPropertyName(n) => Some(PropertyName::ComputedPropertyName(n)),
//             // DeclarationName::ElementAccessExpression(_)
//             // | DeclarationName::BindingPattern(_)
//             // | DeclarationName::EntityNameExpression(_) => None,
//         }
//     }
// }

// pub trait Declaration: IsNode {}

// pub trait NamedDeclaration {
//     fn name(&self) -> Option<DeclarationName>;
// }

// impl<T: IsNode> Declaration for T where T: NamedDeclaration {}
...
// impl<T: UnaryExpression + IsNode> Expression for T {}

// //     /** Deprecated, please use UpdateExpression */
// //     export type IncrementExpression = UpdateExpression;

// pub trait UpdateExpression {}

// impl<T: UpdateExpression> UnaryExpression for T {}
...
// pub trait LeftHandSideExpression {}

// impl<T: LeftHandSideExpression> UpdateExpression for T {}

// pub trait MemberExpression {}

// impl<T: MemberExpression> LeftHandSideExpression for T {}

// pub trait PrimaryExpression {}

// impl<T: PrimaryExpression> MemberExpression for T {}
