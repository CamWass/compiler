...
pub fn skipPartiallyEmittedExpressions(node: Expression) -> Expression {
...
pub fn skipPartiallyEmittedExpressionsOfNode(node: Node) -> Node {
    skipOuterExpressionsOfNode(
        node,
        Some(OuterExpressionKinds::PartiallyEmittedExpressions),
    )
}
...
// TODO: this differes from TSC
pub fn isGeneratedIdentifier(node: &Identifier) -> bool {
    // isIdentifier(node) && (node.autoGenerateFlags & GeneratedIdentifierFlags::KindMask) > GeneratedIdentifierFlags::None
    (node.autoGenerateFlags & GeneratedIdentifierFlags::KindMask) > GeneratedIdentifierFlags::None
}
...
pub fn isModifierKind(token: SyntaxKind) -> bool {
    match token {
...
pub fn isParameterPropertyModifier(kind: SyntaxKind) -> bool {
    modifierToFlag(kind).intersects(ModifierFlags::ParameterPropertyModifier)
}

pub fn isClassMemberModifier(idToken: SyntaxKind) -> bool {
...
pub fn isLeftHandSideExpression(node: Node) -> bool {
    isLeftHandSideExpressionKind(skipPartiallyEmittedExpressionsOfNode(node).kind())
}

fn isLeftHandSideExpressionKind(kind: SyntaxKind) -> bool {
    match kind {
...
pub fn isStringLiteralLike<T: IsNode>(node: &T) -> bool {
