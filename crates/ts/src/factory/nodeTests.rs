...
pub fn isNumericLiteral<T: IsNode>(node: &T) -> bool {
...
pub fn isIdentifier<T: IsNode>(node: &T) -> bool {
...
pub fn isAsyncModifier<T: IsNode>(node: &T) -> bool {
...
pub fn isImportKeyword<T: IsNode>(node: &T) -> bool {
...
pub fn isComputedPropertyName<T: IsNode>(node: &T) -> bool {
...
pub fn isClassStaticBlockDeclaration<T: IsNode>(node: &T) -> bool {
...
pub fn isFunctionTypeNode<T: IsNode>(node: &T) -> bool {
...
pub fn isBindingElement<T: IsNode>(node: &T) -> bool {
    node.kind() == SyntaxKind::BindingElement
}

// Expression

pub fn isArrayLiteralExpression<T: IsNode>(node: &T) -> bool {
    node.kind() == SyntaxKind::ArrayLiteralExpression
}

pub fn isObjectLiteralExpression<T: IsNode>(node: &T) -> bool {
...
pub fn isFunctionExpression<T: IsNode>(node: &T) -> bool {
    node.kind() == SyntaxKind::FunctionExpression
}

pub fn isArrowFunction<T: IsNode>(node: &T) -> bool {
...
pub fn isBinaryExpression<T: IsNode>(node: &T) -> bool {
...
pub fn isClassExpression<T: IsNode>(node: &T) -> bool {
    node.kind() == SyntaxKind::ClassExpression
}

pub fn isOmittedExpression<T: IsNode>(node: &T) -> bool {
...
pub fn isVariableStatement<T: IsNode>(node: &T) -> bool {
...
pub fn isFunctionDeclaration<T: IsNode>(node: &T) -> bool {
    node.kind() == SyntaxKind::FunctionDeclaration
}

pub fn isClassDeclaration<T: IsNode>(node: &T) -> bool {
...
pub fn isModuleDeclaration<T: IsNode>(node: &T) -> bool {
...
// Top-level nodes
pub fn isSourceFile<T: IsNode>(node: &T) -> bool {
