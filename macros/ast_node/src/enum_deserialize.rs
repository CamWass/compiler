                            ...
                            },
                            {
                                match std::result::Result::map(
                                    <VariantFieldType as serde::Deserialize>::deserialize(
                                        global_common::private::serde::de::ContentRefDeserializer::<D::Error>::new(
                                            &content,
                                        ),
                                    ),
                                    Enum::Variant,
                            ...
                            {
                                {
                                    ...
                                    if TAGS.contains(&&*ty.ty) {
                                        return std::result::Result::map(
                                            <VariantFieldType as serde::Deserialize>::deserialize(
                                                global_common::private::serde::de::ContentRefDeserializer::<
                                                    D::Error,
                                                >::new(
                                                    &content
                                                ),
            ...
            .quote_with(smart_quote!(
                ...
                },
                {
                    impl<'de> serde::Deserialize<'de> for Enum {
                        ...
                        {
                            let content =
                                <global_common::private::serde::de::Content as serde::Deserialize>::deserialize(
                                    Deserializer,
                                )?;

                            let ty = global_common::serializer::Type::deserialize(
                                global_common::private::serde::de::ContentRefDeserializer::<D::Error>::new(
                                    &content,
                                ),
                            )?;
